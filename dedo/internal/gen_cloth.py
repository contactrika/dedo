...
def create_cloth_obj(min_point, max_point, node_density,
    ...
    arguments:
        ...
        data_path (str) --> path for storing the temporary cloth obj file (e.g. /tmp/)
        use_hanging_anchors (bool) --> If True, cloth will be annotated with anchors as the top two corners,
            otherwise it will be annotated with left corners
