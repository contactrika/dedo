...
DEFORM_INFO = {
    ...
    'cloth/apron_2.obj': {  # This used to be apron_zehang
        'deform_init_pos': [0, 0.47, 0.47],
        'deform_init_ori': [np.pi/2, 0, np.pi],
        'deform_scale': 0.3,
        'deform_anchor_vertices': [
            [16],   # 11, 13, 14, 15, 16],
            [175],  # 166, 168, 170, 172, 173, 175],
        ],
        'deform_true_loop_vertices': [
            [0, 2, 4, 6, 8, 9, 10, 11, 13, 16, 17, 18, 21, 22, 23, 24, 25, 26, 27, 30, 31, 32, 33, 34, 159, 161, 162,
             164, 165, 166, 167, 168, 170, 174, 175, 177, 179, 180, 181, 182, 183, 184, 187, 188, 189, 289],
            [69, 70, 71, 104, 105, 106, 107, 129, 130, 137, 138, 139, 140, 141, 142, 143, 144, 146, 151, 152, 155, 156,
             157, 158, 210, 211, 240, 241, 242, 243, 264, 265, 271, 272, 273, 274, 275, 277, 278, 279, 281, 286, 287,
             293],
        ],
    },
